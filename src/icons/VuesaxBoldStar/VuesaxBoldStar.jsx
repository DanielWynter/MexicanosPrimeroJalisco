...
export const VuesaxBoldStar = ({ className }) => {
  return (
    <svg
      className={`vuesax-bold-star ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
